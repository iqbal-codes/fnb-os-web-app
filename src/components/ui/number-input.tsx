...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>(
  (
    ...
    // Default decimalScale to 0 (Integer) unless allowDecimals is true or decimalScale is explicitly provided
    const appliedDecimalScale =
      decimalScale !== undefined ? decimalScale : allowDecimals ? undefined : 0;
    ...
    return (
      <div className='flex items-center'>
        <NumericFormat
          ...
          decimalScale={appliedDecimalScale}
